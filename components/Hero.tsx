...
const Hero = () => {
  return (
    <div className='pb-20 pt-36'>
      ...
      <div className="h-[50rem] absolute top-0 left-0  w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.3] bg-grid-black/[0.3] flex items-center justify-center">
      ...
      <div className='flex justify-center relative my-20 z-10  '>
          <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
            ...
            <p className='text-center tracking-widest mb-4 text-sm md:text-lg lg:text-2xl'>Hi! I'm Milad, a Next.js || React.js Developer based in Pakistan.</p>
